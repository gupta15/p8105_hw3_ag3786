...
We will examine the instacart dataset. This dataset has 1384617 observations and 15 variables. The variables `aisle`, `department`, `eval_set` and `product_name` are of class `character`, whereas all remaining variables are of class `integer`.
